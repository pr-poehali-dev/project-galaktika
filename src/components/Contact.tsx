...
const translations = {
  en: {
    heading: "Contact",
    subheading: "Questions, partnerships, or speaking requests — reach out below.",
    email: "Email",
    phone: "Phone",
    message: "Message",
    send: "Send Message",
    ...
    locationValue: "Serampore (Hooghly), India — est. 1800",
    phoneValue: "contact@williamcarey.org",
  },
  de: {
    heading: "Kontakt",
    subheading: "Fragen, Kooperationen oder Vortragsanfragen — schreiben Sie uns.",
    email: "E-Mail",
    phone: "Webseite",
    message: "Nachricht",
    ...
    locationValue: "Serampore (Hooghly), Indien — gegr. 1800",
    phoneValue: "contact@williamcarey.org",
  },
  ru: {
    heading: "Контакты",
    subheading: "Вопросы, партнёрство или приглашения к сотрудничеству — пишите нам.",
    email: "Эл. почта",
    phone: "Сайт",
    message: "Сообщение",
    send: "Отправить",
    location: "Место служения",
    name: "Имя",
    successMessage: "Сообщение успешно отправлено!",
    locationValue: "Серампор (Хугли), Индия — осн. 1800",
    phoneValue: "contact@williamcarey.org",
  },
}
